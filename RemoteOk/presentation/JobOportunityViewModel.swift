...
class JobOportunityViewModelImpl: JobOportunityViewModel {
    ...
    func setupBindings() {
        ...
        setJobAsFavoriteUseCase.didSetJobAsFavorite = { [weak self] isFavorite in
    ...
    func setOpportunityAsFavorite(opportunity: JobOportunity) {
        let newJob = JobOportunity(
            ...
            sourceLogoURL: opportunity.sourceLogoURL,
