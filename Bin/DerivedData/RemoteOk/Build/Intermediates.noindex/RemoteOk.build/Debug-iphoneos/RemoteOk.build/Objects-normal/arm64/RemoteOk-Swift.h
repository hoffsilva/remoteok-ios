...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RemoteOk",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8RemoteOk11AppDelegate")
...
SWIFT_CLASS("_TtC8RemoteOk26LaunchScreenViewController")
...
SWIFT_CLASS_NAMED("OportunityFavorite")
@interface OportunityFavorite : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end


@interface OportunityFavorite (SWIFT_EXTENSION(RemoteOk))
...
@property (nonatomic, copy) NSString * _Nullable epoch;
...
SWIFT_CLASS_NAMED("Opportunity")
@interface Opportunity : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end


@interface Opportunity (SWIFT_EXTENSION(RemoteOk))
@property (nonatomic, copy) NSString * _Nullable company;
@property (nonatomic, copy) NSString * _Nullable date;
@property (nonatomic, copy) NSString * _Nullable desc;
@property (nonatomic, copy) NSString * _Nullable epoch;
